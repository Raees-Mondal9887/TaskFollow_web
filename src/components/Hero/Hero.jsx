...
const Hero = () => {
  return (
    <section class="bg-smoke max-w-80">
      <div class="mx-auto md:mx-5 flex px-2 py-11 md:py-16 md:flex-row flex-col-reverse gap-7 md:gap-0 items-center relative">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-10 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <h1 class="title-font lg:text-3xl text-2xl md:text-2xl mb-4 font-medium text-gray-900">
          ...
          <p class="mb-8 leading-relaxed text-textc">
          ...
          <div class="flex justify-start">
            <button class="cta inline-flex items-center gap-2 md:gap-3 p-8 text-2xl lg:text-4xl text-white bg-secondary border-0 py-1 lg:py-2 px-4 lg:px-6 focus:outline-none rounded ">
              Let's Talk
        ...
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <img class="object-cover object-center rounded" alt="hero" src="SVG image.png" />
        </div>
      </div>
    </section>
  );
